...
Members of group have permission to manage configuration of PDS.
...
Requests reset of password for given managed domain account. 
 Password is reset by PDS upon next cycle od password management (within 5 minutes by default)
